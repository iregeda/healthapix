...
function initDocuMenu() {
	jQuery('#menu-revslider-se2-doc .menu-link , #menu-revslider-jquery-doc .menu-link,#menu-revslider-wp-doc .menu-link ').addClass("docu-link");

	jQuery('#menu-revslider-se2-doc ul, #menu-revslider-jquery-doc ul, #menu-revslider-wp-doc ul').each(function() {
		var ul = jQuery(this),
			li = ul.closest('li');
